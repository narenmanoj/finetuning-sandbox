...
def tokenize_prompt_and_output(prompt_strs: List[str],
    ...
    input_ids = pad_sequence(inputs, batch_first=True, padding_value=0, padding_side="right")
    labels = pad_sequence(labels_lst, batch_first=True, padding_value=0, padding_side="right")
